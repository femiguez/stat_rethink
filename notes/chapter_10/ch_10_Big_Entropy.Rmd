...
In the frequntist world we are trying to justify our methods based on the idea that we are studying processes that could be repeated many, many times.
